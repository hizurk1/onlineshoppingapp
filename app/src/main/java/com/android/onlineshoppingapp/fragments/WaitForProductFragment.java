...
public class WaitForProductFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        orderList.add(new Order("Bánh bao", "BB", "Ngon", 10000, "AAA", 1, 30000, 3));
        orderList.add(new Order("Sữa tươi không đường vị ngon 100% làm từ sữa tốt cho sức khoẻ", "ABC", "Ngon", 5000, "AAA", 1, 35000, 7));
